export const crystalMiningGuide = {
  hero: {
  ...
  notice: {
    title: "Call the mine before you go",
    text:
  ...
  mines: [
    {
      ...
      bestFor: [
        "First-time visitors",
        "Families with kids",
        "Casual crystal digging",
        "Visitors who want a structured stop",
      ],
      hours: [
    ...
    },
    {
      ...
      label: "Best serious crystal stop",
      location: "Fisher Mountain area near Mount Ida",
      address: "11 Logan Gap Road, Mount Ida, AR 71957",
      phone: "870-985-9988",
      website: "https://avantfishermtn.com/pages/mine-your-own-crystals",
      ...
      bestFor: [
        ...
        "Visitors wanting a public dig with clear rules",
      ],
      hours: [
    ...
    },
    {
      ...
      label: "Best rugged dig",
      location: "Story, Arkansas, north of Mount Ida",
      address: "Horseshoe Bend Road, Story, AR 71970",
      phone: "870-867-0104",
      ...
      bestFor: [
        ...
        "Hands-on visitors",
        "Rockhounds",
        "People who call ahead and come prepared",
      ],
      hours: [
  ...
  lesserKnownStops: [
    {
      ...
      label: "Public forest rockhounding",
      location: "Ouachita National Forest, Gardner Mountain area",
      address: "Trailhead off Owley Road, south of Mount Ida",
      phone: "870-867-2101",
      ...
      bestFor: [
        "Outdoor visitors",
        "Hikers",
        "Surface quartz hunting",
        "People who do not need a staffed mine",
      ],
      hours: [
      ...
      howToDig: [
        "Treat this like a hike and surface rockhounding stop, not a mine tour.",
        "Quartz crystals can be collected from the ground surface of the former mine area.",
        "There is no staffed desk, tool rental, gift shop, or guided dig setup.",
      ],
      bring: [
        "Plenty of water",
      ...
      notes: [
        "Forest Service listing says no water is available.",
        "Directions from Mount Ida: travel south on Highway 27 for 3.8 miles, turn east on county road 2237/Owley Road, and continue about 4.1 miles to the trailhead.",
        "Check alerts and weather before heading into the forest.",
      ],
      tip:
        "Separate this from the commercial mines on the page so visitors do not expect a business office or a guided mining setup.",
    },
    {
      name: "Avatar Crystal Mine",
      label: "Primitive seasonal mine",
      location: "Owley Road / Forestry Road W37 area near Mount Ida",
      address: "Owley Road area, Mount Ida, AR 71957",
      phone: "850-227-4814",
      email: "avatarcrystalmine@gmail.com",
      website: "https://www.facebook.com/AvatarCrystalMine/",
      ...
      bestFor: [
        ...
        "People comfortable with fewer amenities",
      ],
      hours: [
      ...
      howToDig: [
        "Contact the mine before driving out for entry details and current digging conditions.",
        "Expect a more primitive dig with fewer amenities than the bigger commercial stops.",
        "Ask what tools are allowed and whether you need to bring your own.",
      ],
      bring: [
        "Water and snacks",
        "Closed-toe shoes or boots",
      ...
      notes: [
        "Online guide material describes a porta-potty onsite but limited amenities otherwise.",
        "Because details are more dependent on Facebook and current mine updates, the page should strongly tell visitors to confirm first.",
      ],
      tip:
    ...
    },
    {
      ...
      label: "Working mine-style dig",
      location: "Mount Ida area",
      address: "Collier Springs Road area, Mount Ida, AR 71957",
      phone: "870-867-4945 / 870-490-0672",
      email: "twincreekmine@yahoo.com",
      website: "https://www.facebook.com/twincreekmine/",
      ...
      bestFor: [
        "Hands-on digging",
        "Rockhounding",
        "All-day outdoor visitors",
        "People who call ahead",
      ],
      hours: [
      ...
      howToDig: [
        "Call or message ahead before planning the day around Twin Creek.",
        "Ask whether the dig is all-day, what areas are open, and what you are allowed to keep.",
        "Some listings mention pocket digs by advance notice, so ask directly if that is what you want.",
      ],
      bring: [
        "Gloves",
        "Water and snacks",
      ...
      notes: [
        "Phone numbers vary across online listings, so the guide should show both and encourage visitors to verify through current Facebook or direct contact.",
        "This is better for prepared visitors than for someone who needs the most predictable beginner stop.",
      ],
      tip:
  ...
  choose: [
    {
      question: "First time crystal digging?",
      answer:
    ...
    {
      question: "Want something more serious or collector-friendly?",
      answer:
    ...
    {
      question: "Want a more primitive dig?",
      answer:
  ...
  weekend: {
    title: "Turn crystal digging into a Mount Ida weekend",
